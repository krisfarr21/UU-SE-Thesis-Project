...
class hf_model():
    ...
    def get_training_data(self) -> pd.DataFrame:
        ...
        if self.training_lingual=='mono':
            ...
            # print("WORKING WITH MONO TRAINING DATA ->", len(self.train_df))
        else:
            ...
            # print(f"length of source language df {length_source_lang} \n")
            ...
            # print(f"num of sentences source {num_of_sentences_source}", f"from other languages {length_to_split*4} \n")
            # print("length to split", length_to_split)
            ...
            # print("length of source lang:", len(source_language_df[:length_to_split*2]))
            # print("number of dfs to concat", len(dfs))

            # concatenate the dataframes
            self.train_df = pd.concat(dfs)

            # print("WORKING WITH MULTI TRAINING DATA ->", len(self.train_df))
    ...
    def training_validation_data(self, split=0.2) -> pd.DataFrame:
        ...
        if self.validation_lingual=='mono':
            ...
            if self.training_lingual=='mono':
                ...
                # print("WORKING WITH MONO VALIDATION DATA ->", "training:", len(self.train_df), "validation:", len(self.valid_df))
            else:
        ...
        # self.training_lingual=='multi'
            ...
            if self.training_lingual=='mono':
                ...
                # print("WORKING WITH MULTI VALIDATION DATA", "training:", len(self.train_df), "validation", len(self.valid_df))
            else:
    ...
    def main(self):
        ...
        print("\n After preprocessing:")
        print("train:", len(self.train_df), "valid", len(self.valid_df), "test", len(self.test_df))
        ...
        # print(len(self.train_df), len(self.valid_df), len(self.test_df))
