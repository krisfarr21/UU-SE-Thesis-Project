...
python /home/krisfarr/thesis/Trainer_implementation/main.py --language arabic --model_checkpoint mbert --training_lingual mono --validation_lingual mono
python /home/krisfarr/thesis/Trainer_implementation/main.py --language arabic --model_checkpoint mbert --training_lingual mono --validation_lingual multi