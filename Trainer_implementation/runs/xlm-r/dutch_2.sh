...
python /home/krisfarr/thesis/Trainer_implementation/main.py --language dutch --model_checkpoint xlm-r --training_lingual multi --validation_lingual mono
python /home/krisfarr/thesis/Trainer_implementation/main.py --language dutch --model_checkpoint xlm-r --training_lingual multi --validation_lingual multi