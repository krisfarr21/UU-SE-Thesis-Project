...
python /home/krisfarr/thesis/Trainer_implementation/main.py --language spanish --model_checkpoint xlm-r --training_lingual mono --validation_lingual mono
python /home/krisfarr/thesis/Trainer_implementation/main.py --language spanish --model_checkpoint xlm-r --training_lingual mono --validation_lingual multi
